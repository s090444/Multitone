...
public class LearningGame extends JFrame implements SwingConstants {
	// Anfang Attribute
	...
	public LearningGame(String title, RootMenu root, int difficulty) {
	...
	public void updateKeys(int i, boolean pressed) { 
		...
		if ((i >= 0) && (i < 10)) {
			...
			System.out.println("Ein Stats ist aufgetreten" + i + "  " + pressed);
		}
	}
	...
	public void createImage(String image){
		try {
			...
			System.out.println("Bild nicht gefunden: " + "src/Pics/" + image );
		}
	}
	...
	public void endGame(){
		...
		Stats Stats = new Stats("Statistik",rounds,errors,average, parent);
